      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <Row>
            ...
            <input type="text" style={{width : "90%"}} placeholder = "20글자 이내로 작성해주세요"/>
            </div>
            </Row>
            ...
            <Row>
                <div style={{margin : "1vh", display : "flex"}}>
                    <Col xs={8}><h5>재방문 하시겠어요?</h5></Col>
                    <Col xs={1}><Button >네</Button></Col>
                    <Col xs={3}> <Button style={{marginLeft : "0.5em"}}>아니오</Button></Col>
                </div>
            </Row>
            <Row>
            <Button style={{width : "90%"}} variant="secondary" onClick={handleClose}>
              작성완료
            </Button>
            </Row>
            <Row>
